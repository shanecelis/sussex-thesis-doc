...
%\usepackage[pdfusetitle,bookmarksnumbered,plainpages=true]{hyperref}
%\usepackage{backref}
...
The equations of motion were derived using AUTOLEV
\citep{ReifKane:2000p3647}.  The source code is provided below.
Figure~\ref{fig:confvars-axes} shows how the axes relate to the rigid
bodies in the code.

\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{fig/confvars-axes.pdf} 
  \caption[Short label]{\label{fig:confvars-axes}Configuration variables and axes used in ``frog.al''}
\end{figure}
