...
{Derivative[1][u1][t] == 
  (-1.*
    (-1.*((-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                Cos[q5[t]])))*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]]) - 
         1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                  Sin[1.570796 + q6[t]])))*(Cos[q3[t]]*Sin[2.356194 + 
                q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]) - 
           1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                  Sin[1.570796 + q7[t]]))*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               Sin[q3[t]]*Sin[5.497787 + q7[t]]) - 1.*Ic*(0.5*fl*mc*
                (0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + q8[t]]))*
                (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]]) - 1.*Ic*(-0.125*l*mb*(4.*Ib + 
                   d*l*mb*Cos[q4[t]])*Sin[q3[t] + q4[t]] + 0.5*Ib*
                  (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                    (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                      Sin[2.356194 + q5[t]]) + fl*mc*(Cos[q3[t]]*
                      Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
                        q6[t]]) + fl*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                     Sin[q3[t]]*Sin[5.497787 + q7[t]]) + fl*mc*(Cos[q3[t]]*
                      Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + 
                        q8[t]])))))))*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
         0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
          Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
          Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]]) - 
       1.*(-0.25*Ic*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                Cos[q5[t]])))*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]]) - 
         1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
            (0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                    q6[t]]))) - 1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*
                Sin[1.570796 - 1.*q7[t]])*(0. + 0.25*Ib*(4.*Ic + 
                 d*fl*mc*Sin[1.570796 + q7[t]])) - 
             1.*Ic*(0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*(0. + 0.25*Ib*
                  (4.*Ic + d*fl*mc*Sin[1.570796 + q8[t]])) - 1.*Ic*
                (-0.0625*(4.*Ib + d*l*mb*Cos[q4[t]])^2 + 0.25*Ib*(4.*Ia + 
                   4.*Ib + 16.*Ic + d*mb*(d + 2.*l*Cos[q4[t]]) + 2.*d*mc*
                    (2.*d + fl*Cos[q5[t]]) + 2.*d*fl*mc*Cos[q6[t]] + 
                   2.*d*fl*mc*Sin[1.570796 + q7[t]] + 2.*d*fl*mc*
                    Sin[1.570796 + q8[t]]))))))*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
             Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*
                mc*Sin[3.926991 + q3[t] + q6[t]])) - 
           1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
                Sin[5.497787 + q3[t] + q7[t]]) - 1.*Ic*(-1.*Ic*
                (0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[q3[t] + q4[t]]) + 
               0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + 
                    q3[t] + q8[t]]))))))*
      ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
          Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
          Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])*
                 ...
                 1.*Ib*(-0.5*Cdcirc*d*rho*u2[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                   0.125*Cdplate*rho*Abs[l*(2.*Cos[q3[t] + q4[t]]*u1[t] + 
                    ...
                    rho*Abs[fl*(2.*Sin[3.926991 + q3[t] + q6[t]]*u1[t] + 
                      ...
                      u2[t] - 1.*d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] - 
                   ...
                   0.5*fl*mc*Sin[5.497787 + q3[t] + q7[t]]*(u3[t] + u7[t])^
                    ...
                    rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                      ...
                      u2[t] + d*Cos[q3[t]]*u3[t] - 1.*d*Sin[q3[t]]*u3[t] - 
                     1.414214*fl*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                       Sin[q3[t]]*Sin[7.068583 + q8[t]])*(u3[t] + 
                       u8[t])))))))) - 
       1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
                  q5[t]] + Sin[q3[t]]*Sin[2.356194 + q5[t]]))) - 
         1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
                    q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]))) - 
           1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
              (0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                 Sin[q3[t]]*Sin[5.497787 + q7[t]])) - 
             1.*Ic*(0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*(0. + 0.5*fl*Ib*mc*
                  (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                    Sin[7.068583 + q8[t]])) - 1.*Ic*(-0.125*l*mb*(4.*Ib + 
                   d*l*mb*Cos[q4[t]])*Sin[q3[t] + q4[t]] + 0.5*Ib*
                  (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                 ...
                 1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                   0.125*Cdplate*rho*Abs[l*(2.*Cos[q3[t] + q4[t]]*u1[t] + 
                    ...
                    Abs[fl*(2.*Sin[2.356194 + q3[t] + q5[t]]*u1[t] + 
                      ...
                      Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] - 1.414214*fl*
                   ...
                   0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                    ...
                    (-2.828427*u1[t] + d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*
                      u3[t] - 1.414214*fl*Sin[3.926991 + q3[t] + q6[t]]*
                    ...
                    Abs[fl*(2.*Sin[5.497787 + q3[t] + q7[t]]*u1[t] + 
                      ...
                      u1[t] + d*Cos[q3[t]]*u3[t] - 1.*d*Sin[q3[t]]*u3[t] - 
                    ...
                    Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                       2.*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                          Sin[7.068583 + q8[t]])*u2[t] + d*Sin[1.570796 + 
                          q8[t]]*u3[t] + fl*(u3[t] + u8[t]))]*(2.828427*
                      u1[t] + d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] + 
                     1.414214*fl*Sin[7.068583 + q3[t] + q8[t]]*(u3[t] + 
                       u8[t]))))))))) + 
     ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
         ...
         1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
             Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*
                mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                  Sin[3.926991 + q6[t]]))) - 
           1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
                (Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                  Sin[5.497787 + q7[t]])) - 1.*Ic*(-1.*Ic*
                (1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*Sin[q3[t] + q4[t]]^
                   2) + 0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                 Sin[q3[t]]*Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*
                  (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                    Sin[7.068583 + q8[t]]))))))*
        (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
          Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         ...
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
          Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + 
            q8[t]]) - 1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
                  q5[t]] + Sin[q3[t]]*Sin[2.356194 + q5[t]]))) - 
         1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
                 ...
                 1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                   ...
                   0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                    ...
                    Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                      ...
                      u1[t] + d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] + 
                     1.414214*fl*Sin[7.068583 + q3[t] + q8[t]]*(u3[t] + 
                       u8[t])))))))) + (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
         0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
          Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
         ...
         1.*Ic*(-1.*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
           ...
           1.*Ic*(1.*Ic*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                ...
                (0.25*(4.*Ib + d*l*mb*Cos[q4[t]])*(Tq4 - 0.25*d*l*mb*
                    ...
                    (2.*Cos[q3[t] + q4[t]]*u1[t] + 2.*Sin[q3[t] + q4[t]]*
                      u2[t] + d*Cos[q4[t]]*u3[t] + l*(u3[t] + u4[t]))) - 
                 1.*Ib*(-1.570796*Cdcirc*d*rho*u3[t] - 0.0625*Cdplate*rho*
                    Abs[l*(2.*Cos[q3[t] + q4[t]]*u1[t] + 2.*Sin[q3[t] + 
                          q4[t]]*u2[t] + d*Cos[q4[t]]*u3[t] + l*(u3[t] + 
                         u4[t]))]*(2.*d*Cos[q3[t]]*u1[t] + 2.*l*Cos[q3[t] + 
                        q4[t]]*u1[t] + 2.*d*Sin[q3[t]]*u2[t] + 2.*l*
                      Sin[q3[t] + q4[t]]*u2[t] + d^2*u3[t] + 2.*d*l*
                   ...
                   0.0625*Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + 
                    ...
                    (-1.414214*d*Cos[q3[t]]*u1[t] - 1.414214*d*Sin[q3[t]]*
                     ...
                     1.*d*fl*Sin[1.570796 - 1.*q8[t]]*u8[t] - 1.*fl^2*
                      ...
                      (-1.*Sin[19.017899006437286 - 1.*q6[t]]*u3[t]^2 - 
                       1.*Sin[q6[t]]*(u3[t] + u6[t])^2) + fl*mc*
                      (-1.*Sin[22.035798012874572 - 1.*q7[t]]*u3[t]^2 - 
                       1.*Sin[q7[t]]*(u3[t] + u7[t])^2) + fl*mc*
                      (-1.*Sin[23.54474887523413 - 1.*q8[t]]*u3[t]^2 - 
                       1.*Sin[q8[t]]*(u3[t] + u8[t])^2)))))))))))/
   (-1.*((-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + 
              d*fl*mc*Cos[q5[t]])))*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
          Sin[q3[t]]*Sin[2.356194 + q5[t]]) - 
        1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Sin[1.570796 + q6[t]])))*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
            Sin[q3[t]]*Sin[3.926991 + q6[t]]) - 
          1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Sin[1.570796 + q7[t]]))*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
              Sin[q3[t]]*Sin[5.497787 + q7[t]]) - 
            1.*Ic*(0.5*fl*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                     q8[t]]))*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                Sin[q3[t]]*Sin[7.068583 + q8[t]]) - 1.*Ic*(-0.125*l*mb*
                 (4.*Ib + d*l*mb*Cos[q4[t]])*Sin[q3[t] + q4[t]] + 
                0.5*Ib*(mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + 
                  fl*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                     Sin[2.356194 + q5[t]]) + fl*mc*(Cos[q3[t]]*
                     Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
                       q6[t]]) + fl*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                    Sin[q3[t]]*Sin[5.497787 + q7[t]]) + fl*mc*(Cos[q3[t]]*
        ...
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
         ...
         Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
         Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*
         Sin[7.068583 + q3[t] + q8[t]]) - 
      1.*(-0.25*Ic*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Cos[q5[t]])))*
         (4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]]) - 
        1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
           (0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                   q6[t]]))) - 1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[
                1.570796 - 1.*q7[t]])*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Sin[1.570796 + q7[t]])) - 1.*Ic*(0.25*(4.*Ic + 
                d*fl*mc*Cos[q8[t]])*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                   Sin[1.570796 + q8[t]])) - 1.*Ic*(-0.0625*
                 (4.*Ib + d*l*mb*Cos[q4[t]])^2 + 0.25*Ib*(4.*Ia + 4.*Ib + 
                  16.*Ic + d*mb*(d + 2.*l*Cos[q4[t]]) + 2.*d*mc*(2.*d + 
                    fl*Cos[q5[t]]) + 2.*d*fl*mc*Cos[q6[t]] + 2.*d*fl*mc*
                   Sin[1.570796 + q7[t]] + 2.*d*fl*mc*Sin[1.570796 + 
                     q8[t]]))))))*(-0.5*fl*Ic*mc*
         (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
           Sin[2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
             Sin[2.356194 + q3[t] + q5[t]])) - 
        1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
            Sin[q3[t]]*Sin[3.926991 + q6[t]])*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
          1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
              Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*Sin[
                5.497787 + q3[t] + q7[t]]) - 1.*Ic*
             (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                 Sin[q3[t] + q4[t]]) + 0.5*fl*mc*(Cos[q3[t]]*
                 Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*(
                0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]]))))))*
     ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
         Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       ...
       (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
             (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*Sin[
                2.356194 + q5[t]])))*Sin[2.356194 + q3[t] + q5[t]] - 
        1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                 Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]])))*
           Sin[3.926991 + q3[t] + q6[t]] - 
          1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                 Sin[3.926991 + q7[t]] + Sin[q3[t]]*Sin[5.497787 + q7[t]]))*
             Sin[5.497787 + q3[t] + q7[t]] - 1.*Ic*
             (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                 Sin[q3[t] + q4[t]]) + 0.5*fl*mc*(0. + 0.5*fl*Ib*mc*
                 (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                   Sin[7.068583 + q8[t]]))*Sin[7.068583 + q3[t] + 
                 q8[t]])))) - 
      1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
         (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
                 q5[t]] + Sin[q3[t]]*Sin[2.356194 + q5[t]]))) - 
                 ...
                 (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                   (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                    ...
                    Sin[q3[t]]*Sin[5.497787 + q7[t]]) + fl*mc*(Cos[q3[t]]*
                     Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + 
                       q8[t]])))))))*
       (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
         (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
        1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
          1.*Ic*(-0.5*fl*Ic*mc*Sin[5.497787 + q3[t] + q7[t]]*
             (0. + 0.5*fl*Ib*mc*Sin[5.497787 + q3[t] + q7[t]]) - 
            1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                 Cos[q3[t] + q4[t]]^2) + 0.5*fl*mc*Sin[7.068583 + q3[t] + 
                 q8[t]]*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + 
                   q8[t]])))))) + 
    ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
          Sin[q3[t]]*Sin[2.356194 + q5[t]])*
         (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
        ...
        1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
          ...
          1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
              Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*(
                Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                 Sin[5.497787 + q7[t]])) - 1.*Ic*
             (-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                 Sin[q3[t] + q4[t]]^2) + 0.5*fl*mc*(Cos[q3[t]]*
                 Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*(
                0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                  Sin[q3[t]]*Sin[7.068583 + q8[t]]))))))*
       (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
         Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
        ...
        1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
          ...
          1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
             ...
             (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                 ...
                 Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*(
                0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]]))))))*
     (-1.*(-0.25*Ic*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Cos[
                q5[t]])))*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]]) - 
        1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
           (0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                   q6[t]]))) - 1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[
                1.570796 - 1.*q7[t]])*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                ...
                d*fl*mc*Cos[q8[t]])*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 ...
                 (4.*Ib + d*l*mb*Cos[q4[t]])^2 + 0.25*Ib*(4.*Ia + 4.*Ib + 
                  16.*Ic + d*mb*(d + 2.*l*Cos[q4[t]]) + 2.*d*mc*(2.*d + 
                   ...
                   Sin[1.570796 + q7[t]] + 2.*d*fl*mc*Sin[1.570796 + 
                     q8[t]]))))))*(-0.5*fl*Ic*mc*
         Sin[2.356194 + q3[t] + q5[t]]*(0. + 1.*Ic^2*
           (0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
        1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
          1.*Ic*(-0.5*fl*Ic*mc*Sin[5.497787 + q3[t] + q7[t]]*
             (0. + 0.5*fl*Ib*mc*Sin[5.497787 + q3[t] + q7[t]]) - 
        ...
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
         Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*
         Sin[7.068583 + q3[t] + q8[t]])*
       (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Cos[
                q5[t]])))*Sin[2.356194 + q3[t] + q5[t]] - 
        1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Sin[1.570796 + q6[t]])))*Sin[3.926991 + q3[t] + q6[t]] - 
          1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Sin[1.570796 + q7[t]]))*Sin[5.497787 + q3[t] + q7[t]] - 
            1.*Ic*(0.5*fl*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                     q8[t]]))*Sin[7.068583 + q3[t] + q8[t]] - 
              1.*Ic*(-0.125*l*mb*(4.*Ib + d*l*mb*Cos[q4[t]])*
                 Cos[q3[t] + q4[t]] + 0.5*Ib*(mb*(d*Cos[q3[t]] + 
                    l*Cos[q3[t] + q4[t]]) + fl*mc*Sin[2.356194 + q3[t] + 
                     q5[t]] + fl*mc*Sin[3.926991 + q3[t] + q6[t]] + 
                  fl*mc*Sin[5.497787 + q3[t] + q7[t]] + fl*mc*Sin[7.068583 + 
                     q3[t] + q8[t]])))))))), Derivative[1][u2][t] == 
  (-1.*((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
         Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
         Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         ...
         (Tq5 - 0.25*d*fl*mc*Sin[q5[t]]*u3[t]^2 + 0.0625*Cdplate*fl*rho*
           Abs[fl*(2.*Sin[2.356194 + q3[t] + q5[t]]*u1[t] + 
            ...
            2.*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*Sin[
                2.356194 + q5[t]])*u2[t] - 1.*d*Sin[1.570796 - 1.*q5[t]]*
             u3[t] - 1.*fl*(u3[t] + u5[t]))) - 
        1.*Ic*(-1.*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                 Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]])))*
           (Tq6 - 0.25*d*fl*mc*Sin[q6[t]]*u3[t]^2 + 0.0625*Cdplate*fl*rho*
                ...
                1.*Ib*(-0.5*Cdcirc*d*rho*u2[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                  ...
                  0.08838835*Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + 
                   ...
                   (-2.828427*u2[t] + d*Cos[q3[t]]*u3[t] - 1.*d*Sin[q3[t]]*
                     u3[t] - 1.414214*fl*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                      Sin[q3[t]]*Sin[7.068583 + q8[t]])*(u3[t] + 
                      u8[t])))))))) - 
      1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
         (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
                ...
                1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                  0.125*Cdplate*rho*Abs[l*(2.*Cos[q3[t] + q4[t]]*u1[t] + 
                   ...
                   Abs[fl*(2.*Sin[2.356194 + q3[t] + q5[t]]*u1[t] + 
                     ...
                     u3[t] + d*Sin[q3[t]]*u3[t] - 1.414214*fl*Sin[2.356194 + 
                  ...
                  0.08838835*Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + 
                      ...
                      d*Sin[1.570796 + q8[t]]*u3[t] + fl*(u3[t] + u8[t]))]*
                   (2.828427*u1[t] + d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*
                     u3[t] + 1.414214*fl*Sin[7.068583 + q3[t] + q8[t]]*
                     (u3[t] + u8[t]))))))))))/
    ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
         Sin[q3[t]]*Sin[2.356194 + q5[t]])*
        (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
             Sin[q3[t]]*Sin[2.356194 + q5[t]]))) - 
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
           Sin[q3[t]]*Sin[3.926991 + q6[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
     ...
     1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
       ...
       1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
                  q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]))) - 
         1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
            (0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                Sin[5.497787 + q7[t]])) - 1.*Ic*
            (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*(0. + 0.5*fl*Ib*mc*
                (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]])) - 1.*Ic*(-0.125*l*mb*(4.*Ib + 
                 d*l*mb*Cos[q4[t]])*Sin[q3[t] + q4[t]] + 0.5*Ib*
                (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                  (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                    Sin[2.356194 + q5[t]]) + fl*mc*(Cos[q3[t]]*Sin[2.356194 + 
                      q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]) + 
                 fl*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                    Sin[5.497787 + q7[t]]) + fl*mc*(Cos[q3[t]]*Sin[5.497787 + 
                      q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])))))))*
      (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
         Sin[q3[t]]*Sin[2.356194 + q5[t]])*
        (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
             Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
              Sin[5.497787 + q3[t] + q7[t]]) - 
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                Sin[q3[t] + q4[t]]) + 0.5*fl*mc*(Cos[q3[t]]*
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
     ...
     (-1.*((-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
          ...
          1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 ...
                 q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]) - 
            1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                   Sin[1.570796 + q7[t]]))*(Cos[q3[t]]*Sin[3.926991 + 
                   q7[t]] + Sin[q3[t]]*Sin[5.497787 + q7[t]]) - 
              1.*Ic*(0.5*fl*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                       q8[t]]))*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                  Sin[q3[t]]*Sin[7.068583 + q8[t]]) - 1.*Ic*(-0.125*l*mb*
                  ...
                  0.5*Ib*(mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + 
                    fl*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                       ...
                       Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
                         q6[t]]) + fl*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                      Sin[q3[t]]*Sin[5.497787 + q7[t]]) + fl*mc*
                     (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                       Sin[7.068583 + q8[t]])))))))*
         (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
           Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          ...
          0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
           ...
           Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
          0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + 
             q8[t]]) - 1.*(-0.25*Ic*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + 
                d*fl*mc*Cos[q5[t]])))*(4.*Ic + d*fl*mc*
             Sin[1.570796 - 1.*q5[t]]) - 
          1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
             (0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                     q6[t]]))) - 1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*
                 Sin[1.570796 - 1.*q7[t]])*(0. + 0.25*Ib*(4.*Ic + 
                  d*fl*mc*Sin[1.570796 + q7[t]])) - 1.*Ic*(0.25*(4.*Ic + 
                  d*fl*mc*Cos[q8[t]])*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                     Sin[1.570796 + q8[t]])) - 1.*Ic*(-0.0625*
                   (4.*Ib + d*l*mb*Cos[q4[t]])^2 + 0.25*Ib*(4.*Ia + 4.*Ib + 
                    16.*Ic + d*mb*(d + 2.*l*Cos[q4[t]]) + 2.*d*mc*(2.*d + 
                     ...
                     Sin[1.570796 + q7[t]] + 2.*d*fl*mc*Sin[1.570796 + 
                       q8[t]]))))))*(-0.5*fl*Ic*mc*
           (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
             Sin[2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[
                2.356194 + q3[t] + q5[t]])) - 
          1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
              Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 
                0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
            1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
                 Sin[5.497787 + q3[t] + q7[t]]) - 1.*Ic*(-1.*Ic*
                 (0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[q3[t] + q4[t]]) + 
       ...
       ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
        ...
        1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
          ...
          1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
             (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
                     q6[t]] + Sin[q3[t]]*Sin[3.926991 + q6[t]]))) - 
            1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*(0. + 
                0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                   Sin[5.497787 + q7[t]])) - 1.*Ic*(0.25*(4.*Ic + 
                  d*fl*mc*Cos[q8[t]])*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                     Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + 
                       q8[t]])) - 1.*Ic*(-0.125*l*mb*(4.*Ib + d*l*mb*
                     Cos[q4[t]])*Sin[q3[t] + q4[t]] + 0.5*Ib*
                   (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                     (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                       Sin[2.356194 + q5[t]]) + fl*mc*(Cos[q3[t]]*
                       Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
      ...
      ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
          ...
          1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
              Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 
                0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                   Sin[3.926991 + q6[t]]))) - 
            1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
                 (Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
         ...
         (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
          ...
          0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
           ...
           Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
          0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + 
             q8[t]]) - 1.*(-0.25*Ic*(4.*Ic + d*fl*mc*
             Sin[1.570796 - 1.*q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(
                Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                 Sin[2.356194 + q5[t]]))) - 
          1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
             (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[2.356194 + 
     ...
     (-1.*((-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
       ...
       ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
          ...
          0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
           ...
           Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
          0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])*
         (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                 Sin[0.7853982 + q5[t]] + Sin[q3[t]]*Sin[2.356194 + q5[t]])))*
           Sin[2.356194 + q3[t] + q5[t]] - 
          1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                 (Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                   Sin[3.926991 + q6[t]])))*Sin[3.926991 + q3[t] + q6[t]] - 
            1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                   Sin[3.926991 + q7[t]] + Sin[q3[t]]*Sin[5.497787 + q7[t]]))*
               Sin[5.497787 + q3[t] + q7[t]] - 1.*Ic*(-1.*Ic*(0. - 
                  0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[q3[t] + q4[t]]) + 
                0.5*fl*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[5.497787 + 
                       q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]]))*
                 Sin[7.068583 + q3[t] + q8[t]])))) - 
        1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
         ...
         (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
          1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
             (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + 
                   q6[t]])) - 1.*Ic*(-0.5*fl*Ic*mc*Sin[5.497787 + q3[t] + 
                 q7[t]]*(0. + 0.5*fl*Ib*mc*Sin[5.497787 + q3[t] + q7[t]]) - 
              1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                   Cos[q3[t] + q4[t]]^2) + 0.5*fl*mc*Sin[7.068583 + q3[t] + 
                   q8[t]]*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + 
                     q8[t]])))))) + 
      ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
       ...
       (-1.*(-0.25*Ic*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
          ...
          0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
           Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
           Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])*
         (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                 Cos[q5[t]])))*Sin[2.356194 + q3[t] + q5[t]] - 
          1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                   Sin[1.570796 + q6[t]])))*Sin[3.926991 + q3[t] + q6[t]] - 
            1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                   Sin[1.570796 + q7[t]]))*Sin[5.497787 + q3[t] + q7[t]] - 
              1.*Ic*(0.5*fl*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                ...
                1.*Ic*(-0.125*l*mb*(4.*Ib + d*l*mb*Cos[q4[t]])*
                   Cos[q3[t] + q4[t]] + 0.5*Ib*(mb*(d*Cos[q3[t]] + 
                      l*Cos[q3[t] + q4[t]]) + fl*mc*Sin[2.356194 + q3[t] + 
                       q5[t]] + fl*mc*Sin[3.926991 + q3[t] + q6[t]] + 
                    fl*mc*Sin[5.497787 + q3[t] + q7[t]] + fl*mc*
                     Sin[7.068583 + q3[t] + q8[t]]))))))))), 
 Derivative[1][u3][t] == 
      ...
      1.*Ic*(-1.*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[
          ...
          0.0625*Cdplate*fl*rho*Abs[fl*(2.*Sin[3.926991 + q3[t] + q6[t]]*u1[
             ...
             u1[t] - 2.*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[
                3.926991 + q6[t]])*u2[t] - 1.*d*Sin[1.570796 - 1.*q6[t]]*
             u3[t] - 1.*fl*(u3[t] + u6[t]))) - 
        1.*Ic*(1.*Ic*(0. + 0.5*fl*Ib*mc*Sin[5.497787 + q3[t] + q7[t]])*
           (Tq7 - 0.25*d*fl*mc*Sin[q7[t]]*u3[t]^2 + 0.0625*Cdplate*fl*rho*
             Abs[fl*(2.*Sin[5.497787 + q3[t] + q7[t]]*u1[t] + 
                2.*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                 ...
                 u3[t] + fl*(u3[t] + u7[t]))]*(-2.*Sin[5.497787 + q3[t] + 
                 q7[t]]*u1[t] - 2.*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                Sin[q3[t]]*Sin[5.497787 + q7[t]])*u2[t] - 1.*d*Sin[
             ...
             (Tq8 + 0.25*d*fl*mc*Sin[22.401931547195208 - 1.*q8[t]]*u3[t]^2 + 
              ...
              1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                ...
                0.08838835*Cdplate*rho*Abs[fl*(2.*Sin[2.356194 + q3[t] + 
                  ...
                  1.*d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] - 1.414214*fl*
                   Sin[2.356194 + q3[t] + q5[t]]*(u3[t] + u5[t])) + 
                0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                   Sin[3.926991 + q6[t]])*(u3[t] + u6[t])^2 + 0.08838835*
                ...
                0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                 ...
                 Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                  ...
                  d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] + 1.414214*fl*
                   Sin[7.068583 + q3[t] + q8[t]]*(u3[t] + u8[t])))))))))/
    (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
      Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
      Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
      Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
     0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
      Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*
      Sin[7.068583 + q3[t] + q8[t]]) + 
   (1.*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
        Sin[q3[t]]*Sin[2.356194 + q5[t]])*
       (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
      1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
          Sin[q3[t]]*Sin[3.926991 + q6[t]])*
        ...
        1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
            Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
             Sin[5.497787 + q3[t] + q7[t]]) - 
          1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[
                q3[t] + q4[t]]) + 0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + 
                 q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
             (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))*
     ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
         Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
        ...
        1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
          ...
          1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
             ...
             (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                 ...
                 Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*(
                0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]]))))))) + 
   (1.*((-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
         (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
        1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
           (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
          1.*Ic*(-0.5*fl*Ic*mc*Sin[5.497787 + q3[t] + q7[t]]*
            ...
            1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                 Cos[q3[t] + q4[t]]^2) + 0.5*fl*mc*Sin[7.068583 + q3[t] + 
                 q8[t]]*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))/
       (0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
         Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
         Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
        0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
      ...
      (1.*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
         ...
         1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
           ...
           1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               ...
               0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + 
                    q3[t] + q8[t]])))))*((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
           0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
           0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
            Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
            Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
          ...
          (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
           ...
           1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                    Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
                      q6[t]])))*Sin[3.926991 + q3[t] + q6[t]] - 
             1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                    Sin[3.926991 + q7[t]] + Sin[q3[t]]*Sin[5.497787 + 
                      q7[t]]))*Sin[5.497787 + q3[t] + q7[t]] - 1.*Ic*
                (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[q3[t] + 
                      q4[t]]) + 0.5*fl*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                      Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + 
                        q8[t]]))*Sin[7.068583 + q3[t] + q8[t]])))) - 
         1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
           ...
           1.*Ic*(0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
             ...
             1.*Ic*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
                (0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                   Sin[q3[t]]*Sin[5.497787 + q7[t]])) - 1.*Ic*
                (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*(0. + 0.5*fl*Ib*mc*
                    (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                      Sin[7.068583 + q8[t]])) - 1.*Ic*(-0.125*l*mb*(4.*Ib + 
                     d*l*mb*Cos[q4[t]])*Sin[q3[t] + q4[t]] + 0.5*Ib*
                    (mb*(d*Sin[q3[t]] + l*Sin[q3[t] + q4[t]]) + fl*mc*
                      ...
                      (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                        Sin[7.068583 + q8[t]])))))))*
          (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + 
                  q5[t]])) - 1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
              (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + 
                    q6[t]])) - 1.*Ic*(-0.5*fl*Ic*mc*Sin[5.497787 + q3[t] + 
                  q7[t]]*(0. + 0.5*fl*Ib*mc*Sin[5.497787 + q3[t] + q7[t]]) - 
               1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
         ...
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
          ...
          Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])*
        ((-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
             Sin[q3[t]]*Sin[2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*
                mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                  Sin[2.356194 + q5[t]]))) - 
           1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                  (Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                    Sin[3.926991 + q6[t]]))) - 1.*Ic*(-0.5*fl*Ic*mc*
                (Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                  Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                    Sin[3.926991 + q7[t]] + Sin[q3[t]]*Sin[5.497787 + 
                      q7[t]])) - 1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 
                   0.25*l^2*mb^2*Sin[q3[t] + q4[t]]^2) + 0.5*fl*mc*
                  (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                    Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                      Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + 
                        q8[t]]))))))*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
           0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
           0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
         ...
         1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
          ...
          (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
             Sin[q3[t]]*Sin[2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*
                mc*Sin[2.356194 + q3[t] + q5[t]])) - 
           1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + Sin[q3[t]]*
                Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                  Sin[3.926991 + q3[t] + q6[t]])) - 1.*Ic*(-0.5*fl*Ic*mc*
                (Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
                  Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*Sin[5.497787 + 
                    q3[t] + q7[t]]) - 1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*
                    Cos[q3[t] + q4[t]]*Sin[q3[t] + q4[t]]) + 0.5*fl*mc*
                  (Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                    Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + 
                      q3[t] + q8[t]]))))))))*
     (-1.*((-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
        ...
        (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
         ...
         1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
           ...
           1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                  Sin[3.926991 + q7[t]] + Sin[q3[t]]*Sin[5.497787 + q7[t]]))*
              Sin[5.497787 + q3[t] + q7[t]] - 1.*Ic*(-1.*Ic*(0. - 
                 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*Sin[q3[t] + q4[t]]) + 0.5*
                fl*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
                   Sin[q3[t]]*Sin[7.068583 + q8[t]]))*Sin[7.068583 + q3[t] + 
                  q8[t]])))) - 
       1.*(-0.25*Ic*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*Sin[0.7853982 + 
                  q5[t]] + Sin[q3[t]]*Sin[2.356194 + q5[t]]))) - 
        ...
        (-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
         ...
         1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
           ...
           1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*
                  Sin[1.570796 + q7[t]]))*Sin[5.497787 + q3[t] + q7[t]] - 
             1.*Ic*(0.5*fl*mc*(0. + 0.25*Ib*(4.*Ic + d*fl*mc*Sin[1.570796 + 
                      q8[t]]))*Sin[7.068583 + q3[t] + q8[t]] - 1.*Ic*
                (-0.125*l*mb*(4.*Ib + d*l*mb*Cos[q4[t]])*Cos[q3[t] + q4[t]] + 
                 0.5*Ib*(mb*(d*Cos[q3[t]] + l*Cos[q3[t] + q4[t]]) + 
                   fl*mc*Sin[2.356194 + q3[t] + q5[t]] + fl*mc*Sin[3.926991 + 
                      q3[t] + q6[t]] + fl*mc*Sin[5.497787 + q3[t] + q7[t]] + 
              ...
              1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                ...
                0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                 ...
                 Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                  ...
                  d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] + 1.414214*fl*
                   Sin[7.068583 + q3[t] + q8[t]]*(u3[t] + u8[t])))))))))/
    (Ib*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
       Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
       Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
       Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) + 
   (1.*((0.5*l*mb*Sin[q3[t] + q4[t]])/Ib - (0.25*(4.*Ib + d*l*mb*Cos[q4[t]])*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
           ...
           1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               ...
               0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + 
                    q3[t] + q8[t]]))))))/
       (Ib*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*
          Cos[q4[t]]*Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
          Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
       ...
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
           ...
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                ...
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0.5*l*mb*Cos[q3[t] + q4[t]])/Ib - (0.25*(4.*Ib + d*l*mb*Cos[q4[t]])*
        (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + 
             ...
             1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                  Cos[q3[t] + q4[t]]^2) + 0.5*fl*mc*Sin[7.068583 + q3[t] + 
                  q8[t]]*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + 
                    q8[t]]))))))/(Ib*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
         0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
          Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q7[t]]*
          Sin[5.497787 + q3[t] + q7[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) - 
      (1.*((0.5*l*mb*Sin[q3[t] + q4[t]])/Ib - 
         (0.25*(4.*Ib + d*l*mb*Cos[q4[t]])*(-0.5*fl*Ic*mc*
             (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*Sin[
                2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                 Sin[2.356194 + q3[t] + q5[t]])) - 
            1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
                Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*
                 (0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
              1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
                  Sin[q3[t]]*Sin[5.497787 + q7[t]])*(0. + 0.5*fl*Ib*mc*
                   Sin[5.497787 + q3[t] + q7[t]]) - 1.*Ic*
                 (-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
        ...
        ((0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
           ...
           0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
            ...
            Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
           0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + 
              q8[t]])*(-0.5*fl*Ic*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*
                  Sin[2.356194 + q5[t]])))*Sin[2.356194 + q3[t] + q5[t]] - 
           1.*Ic*(0.5*fl*mc*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
                    Sin[2.356194 + q6[t]] + Sin[q3[t]]*Sin[3.926991 + 
                      q6[t]])))*Sin[3.926991 + q3[t] + q6[t]] - 
             1.*Ic*(-0.5*fl*Ic*mc*(0. + 0.5*fl*Ib*mc*(Cos[q3[t]]*
              ...
              1.*Ib*(-0.5*Cdcirc*d*rho*u1[t]*(u1[t]^2 + u2[t]^2)^0.5 - 
                ...
                0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                 ...
                 Cdplate*rho*Abs[fl*(2.*Sin[7.068583 + q3[t] + q8[t]]*u1[t] + 
                  ...
                  d*Cos[q3[t]]*u3[t] + d*Sin[q3[t]]*u3[t] + 1.414214*fl*
                   Sin[7.068583 + q3[t] + q8[t]]*(u3[t] + u8[t])))))))))/
    (Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
       Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
       Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
       Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) + 
   (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
         Sin[q3[t]]*Sin[2.356194 + q5[t]]))/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
           ...
           1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
               ...
               0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + Sin[q3[t]]*
                  Sin[7.068583 + q8[t]])*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + 
                    q3[t] + q8[t]]))))))/
       (Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*
          Cos[q4[t]]*Cos[q3[t] + q4[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q5[t]]*Sin[2.356194 + q3[t] + q5[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
          Sin[3.926991 + q3[t] + q6[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
       ...
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
           ...
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                ...
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0.5*fl*mc*Sin[2.356194 + q3[t] + q5[t]])/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
        (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
            (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + 
             ...
             1.*Ic*(-1.*Ic*(1.*Ib*(ma + mb + 4.*mc) - 0.25*l^2*mb^2*
                  Cos[q3[t] + q4[t]]^2) + 0.5*fl*mc*Sin[7.068583 + q3[t] + 
                  q8[t]]*(0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + 
                    q8[t]]))))))/(Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 
         0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*Cos[q3[t] + q4[t]] - 
         0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q5[t]]*
          Sin[2.356194 + q3[t] + q5[t]] - 0.125*d*fl^2*Ib*Ic^3*mc^2*
          Sin[1.570796 - 1.*q6[t]]*Sin[3.926991 + q3[t] + q6[t]] - 
      ...
      (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
         ...
         (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q5[t]])*
           (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
              Sin[q3[t]]*Sin[2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 
                0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
            1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
                Sin[q3[t]]*Sin[3.926991 + q6[t]])*(0. + 1.*Ic^2*
                 (0. + 0.5*fl*Ib*mc*Sin[3.926991 + q3[t] + q6[t]])) - 
              1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
   ...
   (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
    ...
    (Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
      ...
      0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       ...
       Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) + 
   (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         Sin[q3[t]]*Sin[3.926991 + q6[t]]))/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
       ...
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
           ...
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                ...
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]])/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q6[t]])*
        (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
 ...
 Derivative[1][u7][t] == 
  (1.*(Tq7 - 0.25*d*fl*mc*Sin[q7[t]]*u3[t]^2 + 0.0625*Cdplate*fl*rho*
       Abs[fl*(2.*Sin[5.497787 + q3[t] + q7[t]]*u1[t] + 
        ...
        2.*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + Sin[q3[t]]*
           Sin[5.497787 + q7[t]])*u2[t] - 1.*d*Sin[1.570796 - 1.*q7[t]]*
         u3[t] - 1.*fl*(u3[t] + u7[t]))))/Ic + 
   (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
    ...
    (Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
      ...
      0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       ...
       Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) + 
   (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
         Sin[q3[t]]*Sin[5.497787 + q7[t]]))/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
       ...
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
           ...
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                ...
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0.5*fl*mc*Sin[5.497787 + q3[t] + q7[t]])/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Sin[1.570796 - 1.*q7[t]])*
        (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
   ...
   (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*
    ...
    (Ic*(0. + 0.5*d*Ib*Ic^4*mb*Cos[q3[t]] - 0.125*d*Ic^4*l^2*mb^2*Cos[q4[t]]*
      ...
      0.125*d*fl^2*Ib*Ic^3*mc^2*Sin[1.570796 - 1.*q6[t]]*
       ...
       Sin[1.570796 - 1.*q7[t]]*Sin[5.497787 + q3[t] + q7[t]] - 
      0.125*d*fl^2*Ib*Ic^3*mc^2*Cos[q8[t]]*Sin[7.068583 + q3[t] + q8[t]])) + 
   (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
         Sin[q3[t]]*Sin[7.068583 + q8[t]]))/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*
        (-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[0.7853982 + q5[t]] + 
           Sin[q3[t]]*Sin[2.356194 + q5[t]])*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
       ...
       1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
         ...
         1.*Ic*(-0.5*fl*Ic*mc*(Cos[q3[t]]*Sin[3.926991 + q7[t]] + 
           ...
           1.*Ic*(-1.*Ic*(0. - 0.25*l^2*mb^2*Cos[q3[t] + q4[t]]*
                ...
                Sin[5.497787 + q8[t]] + Sin[q3[t]]*Sin[7.068583 + q8[t]])*
              (0. + 0.5*fl*Ib*mc*Sin[7.068583 + q3[t] + q8[t]])))))) + 
   (1.*((0.5*fl*mc*Sin[7.068583 + q3[t] + q8[t]])/Ic - 
      (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*
        (-0.5*fl*Ic*mc*Sin[2.356194 + q3[t] + q5[t]]*
          (0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*Sin[2.356194 + q3[t] + q5[t]])) - 
         1.*Ic*(0.5*fl*mc*Sin[3.926991 + q3[t] + q6[t]]*
      ...
      (1.*((0.5*fl*mc*(Cos[q3[t]]*Sin[5.497787 + q8[t]] + 
            Sin[q3[t]]*Sin[7.068583 + q8[t]]))/Ic - 
         (0.25*(4.*Ic + d*fl*mc*Cos[q8[t]])*(-0.5*fl*Ic*mc*
             (Cos[q3[t]]*Sin[0.7853982 + q5[t]] + Sin[q3[t]]*Sin[
                2.356194 + q5[t]])*(0. + 1.*Ic^2*(0. + 0.5*fl*Ib*mc*
                 Sin[2.356194 + q3[t] + q5[t]])) - 
            1.*Ic*(0.5*fl*mc*(Cos[q3[t]]*Sin[2.356194 + q6[t]] + 
